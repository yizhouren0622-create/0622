...
| [`script/01_第一章_日复一日.md`](./script/01_第一章_日复一日.md) | 第一章（对齐 `剧本汇总_第一章_现行.md`） |
...
> 仓库根目录的 **`剧本汇总_第一章_现行.md`** 与 demo 启动文件为定稿／工程文件，**请勿用 sync 覆盖或改动**。  
> `Ai/剧本汇总_演出顺序全本.md` 仅由 `Ai/script/` 生成。
